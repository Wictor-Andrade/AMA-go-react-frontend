...
export function CreateRoom() {
    ...
    function handleCreateRoom(data: FormData) {
        ...
        navigate('room/1123123213123')
    }

    return (
        <main className='h-screen items-center flex justify-center px-4'>
            <div className='max-w-[450px] flex flex-col gap-6'>
                <img src={amalogo} alt="AMA LOGO" className='h-10' />
                <p className='leading-relaxed text-zinc-300 text-center'>
                    Crie uma sala pública de AMA (Ask me anything) e priorize as perguntas mais importantes para a comunidade.</p>
                <form
